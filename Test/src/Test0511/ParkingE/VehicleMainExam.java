	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < vehicles.length; i++) {
			...
			while (isRun) {
				...
				switch (kind) {
				case "Suv":
					vehicles[i] = new Suv(Kind.valueOf(kind), intTime, outTime);
					isRun = !isRun;
					break;
				case "Sedan":
					vehicles[i] = new Sedan(Kind.valueOf(kind), intTime, outTime);
					isRun = !isRun;
					break;
				case "Truck":
					vehicles[i] = new Truck(Kind.valueOf(kind), intTime, outTime);
					isRun = !isRun;
					break;
				default:
					System.out.print("차종을 선택하세요>[Suv/Sedan/Truck]");
...
class Suv extends Vehicle {
	...
	public Suv(Kind kind, int intTime, int outTime) {
...
class Sedan extends Vehicle {
	...
	public Sedan(Kind kind, int intTime, int outTime) {
		super(kind, intTime, outTime);
		// TODO Auto-generated constructor stub
	}
...
class Truck extends Vehicle {
	...
	public Truck(Kind kind, int intTime, int outTime) {
		super(kind, intTime, outTime);
		// TODO Auto-generated constructor stub
	}
