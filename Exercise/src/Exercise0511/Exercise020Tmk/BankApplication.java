package Exercise0511.Exercise020Tmk;
...
public class BankApplication {
	...
	private static void createAccount() {
		...
		System.out.println("--------");
		/*
		 * System.out.print("계좌 번호: "); String ano = scanner.next();
		 */
	...
	private static void transfer() {
		System.out.print("출금 계좌 번호를 입력하세요> ");
		String ano1 = scanner.next();
		Account account1 = findAccount(ano1);
		System.out.print("상대 계좌 번호를 입력하세요> ");
	...
	private static void secession() {
		...
		System.out.println("--------");
		System.out.print("탈퇴 할 계좌 번호를 입력하세요> ");
		String ano = scanner.next();
